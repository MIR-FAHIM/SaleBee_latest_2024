...
class MyTaskView extends GetView<TaskController> {
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: controller.filteredMyTaskList.where((element) => element.dueDate!.day == controller.daySelection.value
                ...
                &&element.dueDate!.year == controller.yearSelection.value).toList().isEmpty
                ? Text("No Task for this day")
                : ListView.builder(
                    itemCount: controller.filteredMyTaskList.where((element) => element.dueDate!.day == controller.daySelection.value

                        &&element.dueDate!.month == controller.monthSelection.value
                        &&element.dueDate!.year == controller.yearSelection.value).length,
                    itemBuilder: (context, index) {
                      var data = controller.filteredMyTaskList.where((element) => element.dueDate!.day == controller.daySelection.value
