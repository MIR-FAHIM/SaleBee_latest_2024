...
class AssignedByMeTaskView extends GetView<TaskController> {
  @override
          ...
          body: Column(
            children: [
              ...
              Container(
                ...
                child: controller.filteredAssignedByMeTaskList.isEmpty
                    ? Text("No Task Found")
                    : ListView.builder(
                    itemCount: controller.filteredAssignedByMeTaskList.where((element) => element.dueDate!.day == controller.daySelection.value

                        &&element.dueDate!.month == controller.monthSelection.value
                        &&element.dueDate!.year == controller.yearSelection.value).length,
                    itemBuilder: (context, index) {
                      var data = controller.filteredAssignedByMeTaskList.where((element) => element.dueDate!.day == controller.daySelection.value
