            ...
            children: [
              ...
              Container(
                ...
                child: controller.filteredAllTaskList.isEmpty
                    ? Text("No Task Found")
                    : ListView.builder(
                    itemCount: controller.filteredAllTaskList.where((element) => element.dueDate!.day == controller.daySelection.value

                        &&element.dueDate!.month == controller.monthSelection.value
                        &&element.dueDate!.year == controller.yearSelection.value).length,
                    itemBuilder: (context, index) {
                      var data = controller.filteredAllTaskList.where((element) => element.dueDate!.day == controller.daySelection.value
