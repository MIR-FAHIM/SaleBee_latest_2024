...
class AddExpenseTransportView extends GetWidget<ExpenseController> {
  @override
              ...
              Container(
                ...
                child: GridView.builder(
                    gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
                        ...
                        crossAxisSpacing: 10,
                        mainAxisSpacing: 10),
                    itemCount: controller.wayList.length,
                          ...
                          return InkWell(
                            onTap: () {
                              controller.selectedType.value =
                                  controller.wayList[index];
                              print("my way is ${controller.selectedType.value}");
                            },
                            child: Container(
                          ...
                          children: [
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                controller:
                                    controller.endLocationController.value,
                                keyboardType: TextInputType.text,
                                decoration: InputDecoration(
                                  prefix: Container(
                                    width: 20,
