...
class AddFoodExView extends GetWidget<ExpenseController> {
  @override
                ...
                children: [
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: controller.imageList.value.length > 0
                          ? Image.file(File(controller.imageList.value[0].path))
                          : const Center(
                        child: Icon(
                          Icons.add,
                          size: 40,
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child:controller.imageList.value.length > 1
                          ? Image.file(File(controller.imageList.value[1].path))
                          : const Center(
                        child: Icon(
                          Icons.add,
                          size: 40,
