...
class ExpenseView extends GetView<ExpenseController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text("Food Expense"),
        ),
        body: Obx(
                () {
              if(controller.getAllExpenseModel.value.result == null){
                return InkWell(
                  onTap: () {
                                                          ...
                                                          children: [
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: FittedBox(
                                                                fit: BoxFit.fitWidth,
                                                                child: Text(
                                                                  controller.getAllExpenseModel.value.result!.statusCount[0].totalAmount.toString(),
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child: FittedBox(
                                                                        fit: BoxFit.fitWidth,
                                                                        child: Text(
                                                                          controller.getAllExpenseModel.value.result!.statusCount[1].totalAmount.toString(),
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child: FittedBox(
                                                                        fit: BoxFit.fitWidth,
                                                                        child: Text(
                                                                          controller.getAllExpenseModel.value.result!.statusCount[3].totalAmount.toString(),
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child: FittedBox(
                                                                        fit: BoxFit.fitWidth,
                                                                        child: Text(
                                                                          controller.getAllExpenseModel.value.result!.statusCount[2].totalAmount.toString(),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TabBarView(children: [
                                    ...
                                    Container(
                                      height: Get.height * .4,
                                      child: controller.filteredAllExpenseList.where((element) => element.status == "Claimed").isEmpty
                                          ? Text("Loading.....")
                                          : ListView.builder(
                                          itemCount: controller.filteredAllExpenseList.where((element) => element.status == "Claimed").length,
                                          itemBuilder: (context, index) {
                                            var data = controller.filteredAllExpenseList.where((element) => element.status == "Claimed").toList()[index];
                                    ...
                                    Container(
                                      height: Get.height * .4,
                                      child: controller.filteredAllExpenseList.where((element) => element.status == "Approved").isEmpty
                                          ? Text("Loading.....")
                                          : ListView.builder(
                                          itemCount: controller.filteredAllExpenseList.where((element) => element.status == "Approved").length,
                                          itemBuilder: (context, index) {
                                            var data = controller.filteredAllExpenseList.where((element) => element.status == "Approved").toList()[index];
                                            return GestureDetector(
                                              onTap: () {},
                                              child: Card(
                                                shape: RoundedRectangleBorder(
                                    ...
                                    Container(
                                      height: Get.height * .4,
                                      child: controller.filteredAllExpenseList.where((element) => element.status == "Rejected").isEmpty
                                          ? Text("Loading.....")
                                          : ListView.builder(
                                          itemCount: controller.filteredAllExpenseList.where((element) => element.status == "Rejected").length,
                                          itemBuilder: (context, index) {
                                            var data = controller.filteredAllExpenseList.where((element) => element.status == "Rejected").toList()[index];
                                            return GestureDetector(
                                              onTap: () {},
                                              child: Card(
                                                shape: RoundedRectangleBorder(
