...
class AllEmployeeListModel {
  ...
  String? message;
  List<EmpResults>? results;
  bool? isSuccess;

  factory AllEmployeeListModel.fromJson(Map<String, dynamic> json) => AllEmployeeListModel(
    message: json["Message"],
    results: List<EmpResults>.from(json["Result"].map((x) => EmpResults.fromJson(x))),
...
class EmpResults {
  ...
  factory EmpResults.fromJson(Map<String, dynamic> json) => EmpResults(
