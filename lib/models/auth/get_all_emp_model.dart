...
class AllEmployeeListModel {
  ...
  String? message;
  List<ResultsEmployee>? results;
  bool? isSuccess;

  factory AllEmployeeListModel.fromJson(Map<String, dynamic> json) => AllEmployeeListModel(
    message: json["Message"],
    results: List<ResultsEmployee>.from(json["Result"].map((x) => ResultsEmployee.fromJson(x))),
...
class ResultsEmployee {
  ...
  factory ResultsEmployee.fromJson(Map<String, dynamic> json) => ResultsEmployee(
