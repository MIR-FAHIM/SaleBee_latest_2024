...
GetMyTaskModel getAllMyTaskModelFromJson(String str) => GetMyTaskModel.fromJson(json.decode(str));

String getAllMyTaskModelModelToJson(GetMyTaskModel data) => json.encode(data.toJson());
...
class GetMyTaskModel {
  ...
  factory GetMyTaskModel.fromJson(Map<String, dynamic> json) => GetMyTaskModel(
